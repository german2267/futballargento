      ...
      $submitBtn = $_POST['submit'];
        ...
        if(isset($submitBtn)){
          ...
          echo '<br> <button type="button" class="btn btn-outline-info"><a href="../visualMods/recuPassRepre.php" style="text-decoration:none;">Vover</a></button>';
            ...
            $sqlPost = "SELECT * FROM representantes WHERE email = '$emailUser'AND num_rep = '$telUser' AND dni = '$dniUser' ";
                ...
                if($sqlEX->num_rows>0){
                  ...
                  //otorgamiento de contraseña via servicio mailing, en cuanto este hosteado
                    //generacion de clave alfanumerica aleatoria de 8 caracteres
                      ...
                      $updateSql = "UPDATE representantes SET password = '$pwd' , validacion = '$validacion'";
