...
<div class="input-group mb-3">
  <input type="email" class="form-control" placeholder="Ingresar Email" aria-label="Recipient's username" aria-describedby="basic-addon2" name="correo" required>
</div>

 <div class="input-group mb-3">
  <input type="text" class="form-control" placeholder="Entidad Social" aria-label="direccion" aria-describedby="basic-addon1" name="ent_soc" required>
</div>
