        ...
        <div class="container">
            ...
            <div class="row mx-auto shadow mt-4" style="max-width: 48rem; border: 1px solid #d0d0d0;">
                <div class="col-12 bg-light" style="border-bottom: 1px solid #d0d0d0;">
                    <h2 class="text-center font-weight-bold">REGISTRO DE POSTULANTE</h2>
                </div>
                <div class="col-12 col-md-4 bg-primary position-relative" style="border-right: 1px solid #d0d0d0; background: linear-gradient(135deg, #007bff 0%, #6f42c1 100%);">
                ...
                <div class="col-12 col-md-8 bg-light py-3" style="border-left: 1px solid #d0d0d0;">
                    <form action="">
                        ...
                        <div class="form-group">
                            <label for="jugada">Jugada Demostrativa</label>
                            <input type="text" class="form-control" placeholder="Ej: https://www.youtube.com/watch?..." id="jugada" required>
                        </div>
                        ...
                        <a href="regPost.php" class="ml-2">No tengo Comet</a>
                    </form>
                </div>
            </div>
        </div>
